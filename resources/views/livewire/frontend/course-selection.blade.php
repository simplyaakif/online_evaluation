    ...
    <div class="bg-white md:col-span-4 overflow-hidden shadow rounded-lg">
        ...
        <div class="px-4 py-5 sm:p-6">
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label for="course_duration" class="block text-sm font-medium text-gray-700">Select Duration</label>
                ...
                <div>
                    <label for="learning_mode" class="block text-sm font-medium text-gray-700">Mode of Learning</label>
...
{{--            <hr>--}}
            <span class="text-sm">{{$testVariable}}</span>
            @isset($testVariable->session_duration[$course_duration]->pivot->price)
            <div class="px-4 py-3 sm:px-6 sm:py-2">
                <h2>Course Price</h2>
                <h3 class="text-2xl font-semibold text-gray-600">
                    {{$course_duration->pivot->price}} Rs
                </h3>
            </div>
            @endisset
