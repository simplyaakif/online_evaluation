<form wire:submit.prevent="submit" class="pt-3">
    ...
    <div class="form-group {{ $errors->has('session_time') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="session_time" name="session_time" wire:model="session_time" :options="$this->listsForFields['session_time']" multiple />
        <div class="validation-message">
    ...
    <div class="form-group {{ $errors->has('session_start_date') ? 'invalid' : '' }}">
        ...
        <x-select-list class="form-control" id="session_start_date" name="session_start_date" wire:model="session_start_date" :options="$this->listsForFields['session_start_date']" multiple />
        <div class="validation-message">
